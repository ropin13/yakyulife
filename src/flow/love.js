...
import {STUDENT_PEOPLE} from '../data/relationship/people_student.js?v=offline-0.31.1';
import {PROFESSIONAL_PEOPLE} from '../data/relationship/people_professional.js?v=offline-0.31.1';
import {pregnancyChance, PREGNANCY_RULES} from '../data/relationship/pregnancy_rules.js?v=offline-0.31.1';

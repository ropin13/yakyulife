...
import {R, pick, chance, clamp} from '../core/rng.js?v=offline-0.31.1';
...
import {EVENTS, EVENT_CATEGORY_NAMES, EVENT_COMBINATIONS, EVENT_ROUTES, eventInjuryRisk} from '../data/events.js?v=offline-0.31.1';
import {card, choose, board} from '../ui/dom.js?v=offline-0.31.1';
import {addAb, statBonus, statBonusTxt, abGainTxt, ovr} from '../engine/ability.js?v=offline-0.31.1';
import {majorChampionshipCount} from '../engine/championship.js?v=offline-0.31.1';

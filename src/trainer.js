import {S,setS} from './core/state.js?v=offline-0.31.0';
import {SEED,setSeed,seedInit} from './core/rng.js?v=offline-0.31.0';
import {ABL,ABILITY_MAX,POTENTIAL_MAX} from './data/abilities.js?v=offline-0.31.0';
import {$,board,card,restoreLogTarget} from './ui/dom.js?v=offline-0.31.0';
import {resetTL,renderTimeline,timelineSnapshot,restoreTimeline} from './ui/timeline.js?v=offline-0.31.0';
import {startYear} from './flow/phases.js?v=offline-0.31.0';
import {APP_VER} from './config.js?v=offline-0.31.0';
import {injuryProb,tjCap} from './engine/injury.js?v=offline-0.31.0';
import {ovr} from './engine/ability.js?v=offline-0.31.0';
import {LV} from './data/teams.js?v=offline-0.31.0';
import {teamChampRate,teamChampRates} from './engine/contract.js?v=offline-0.31.0';
import {loadRelationshipDatabase,relationshipDatabaseSnapshot,applyRelationshipDatabaseSnapshot} from './data/relationship/database.js?v=offline-0.31.0';
import {loadInternationalDatabase} from './data/international.js?v=offline-0.31.0';
import {internationalDatabaseSnapshot,applyInternationalDatabaseSnapshot} from './data/international_database.js?v=offline-0.31.0';
import {sessionSnapshot,prepareReplay,restoreReplayRng} from './core/session.js?v=offline-0.31.0';
import {refreshAlloc} from './ui/alloc.js?v=offline-0.31.0';

import {S, blankStat, bucketOf, nextStep, stageLabel} from '../core/state.js?v=offline-0.31.1';
import {R, ri, chance, clamp, N0} from '../core/rng.js?v=offline-0.31.1';
import {POS_ADJ_RUNS, POS_PT_BAR} from '../data/abilities.js?v=offline-0.31.1';
...
import {card, board} from '../ui/dom.js?v=offline-0.31.1';
import {ovr, careerAllStars, toolGap} from './ability.js?v=offline-0.31.1';
import {tjAccrue, tjGamble} from './injury.js?v=offline-0.31.1';
/* temporary scaffold until awards/intl/contract/flow are extracted */
import {demotionAudit} from './contract.js?v=offline-0.31.1';
import {awards} from './awards.js?v=offline-0.31.1';
import {maybeIntl} from './intl.js?v=offline-0.31.1';
import {traitCard, removeTrait} from '../flow/events.js?v=offline-0.31.1';
import {proPersonalAwards} from './pro-awards.js?v=offline-0.31.1';
import {amateurRankIndex} from './amateur-result.js?v=offline-0.31.1';

...
import {R, ri, pick, chance, clamp, SEED} from '../core/rng.js?v=offline-0.30.0';
import {LV, PATHS, CPBL_TEAMS, NPB_TEAMS, MLB_TEAMS} from '../data/teams.js?v=offline-0.30.0';
import {AMA_ANNUAL, LEVEL_MIN_ANNUAL, MLB_SERVICE_MINOR_MIN} from '../data/economy.js?v=offline-0.30.0';
...
import {injuryMarketStatus} from './injury.js?v=offline-0.30.0';
import {hasActiveFranchise} from './tenure.js?v=offline-0.30.0';
import {seasonSalaryRating, currentSalaryRating} from './season.js?v=offline-0.30.0';
import {capTeam} from './career.js?v=offline-0.30.0';
import {traitCard, removeTrait} from '../flow/events.js?v=offline-0.30.0';
import {advance} from './draft.js?v=offline-0.30.0';
import {finishContractYear} from '../flow/phases.js?v=offline-0.30.0';

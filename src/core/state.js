import {R, ri} from './rng.js?v=offline-0.30.0';
import {POS_AB,POTENTIAL_MAX} from '../data/abilities.js?v=offline-0.30.0';
import {LV,TW_HS_SCHOOLS,schoolList,schoolTier} from '../data/teams.js?v=offline-0.30.0';
